...
__decorate([
    (0, swagger_1.ApiProperty)({ type: 'string', format: 'string' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ type: 'string', format: 'email' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEmail)(),
    __metadata("design:type", String)
], CreateProfileDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: 'string', format: 'mobile' }),
    (0, class_validator_1.IsOptional)(),
...
//# sourceMappingURL=create_profile.dto.js.map